	...
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo $_GET['id']."_".rand(10,100); ?>"/></td>
				</tr>
				<!--<tr>-->
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://www.coachtofortune.com/event/pay1/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://www.coachtofortune.com/event/pay1/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?php echo $_GET['name'] ?>"/></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	<td>Billing Tel	:</td><td><input type="text" name="billing_tel" value="<?php echo $_GET['phone'] ?>"/></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?php echo $_GET['email'] ?>"/></td>
		        </tr>
		        <tr>
